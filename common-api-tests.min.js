...
function getSchemaHAL(a){a=void 0===a?{}:a;if("Object"===getType(a))return{type:"object",required:["_links","_embedded","_page"],properties:{_links:{type:"object",required:["self","next","previous","first","last"],properties:{self:{type:"object",required:["href"],properties:{href:{type:"string",pattern:getRegexURL()}}},next:{type:["object","null"],required:["href"],properties:{href:{type:"string",pattern:getRegexURL()}}},previous:{type:["object","null"],required:["href"],properties:{href:{type:"string",
pattern:getRegexURL()}}},first:{type:"object",required:["href"],properties:{href:{type:"string",pattern:getRegexURL()}}},last:{type:"object",required:["href"],properties:{href:{type:"string",pattern:getRegexURL()}}}}},_embedded:{type:"object",required:["resourceList"],properties:{resourceList:{type:"array",items:a}}},_page:{type:"object",required:["size","number"],properties:{size:{type:"number",minimum:0,multipleOf:1},totalElements:{type:"number",minimum:0,multipleOf:1},totalPages:{type:"number",
minimum:0,multipleOf:1},number:{type:"number",minimum:0,multipleOf:1}}}}};throw new TypeError('Parameter value must be an object for function "getSchemaHAL(schemaResourceItems)"');};
